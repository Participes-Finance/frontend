...
const supportedChainIds = [1, 4, 137, 1337, 80001]; // chain IDs supported by this app
...
export default function useWalletStore() {
  ...
  async function configureProvider() {
    ...
    // Get ENS name ---> WAS RETURNING ERRORS SINCE POLYGON AND SOME OTHER NETWORKS DO NO SUPPORT ENS :c
